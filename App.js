        ...
        <RenderHeader navigation={this.props.navigation} />
          <ImageBackground source={field} style={{width: '100%', height: '100%'}} style={viewStyles}>
            <TouchableOpacity onPress={() => {this.props.navigation.navigate("Äta", {rand: Math.floor(Math.random() * (1 + 1000))})}}>
              <Image
                source={require('./menu_icons4/ata.png')}
...
class MenuScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = { isLoading: true, search: '', dStart: require('./menu_icons/start.png'), dAta: require('./menu_icons/ata.png'), dProducent: require('./menu_icons/producent.png'), dGardsbutik: require('./menu_icons2/Hem.png'), dKarta: require('./menu_icons2/Karta.png'), dSok: require('./menu_icons2/Event.png') };
    this.arrayholder = [];
  }
